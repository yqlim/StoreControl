    ...
    _createClass(StoreControl, [{
      ...
      value: function set(key, val) {
        ...
        if (i < 0) {
          i = this.size();
          this.entries[i] = [];
        } else if (this.values[i] instanceof StoreControl) throw new TypeError("Cannot replace ".concat(key, " because it is a user-defined StoreControl branch."));
      ...
      value: function branch(id) {
        if (this.has(id)) throw new ReferenceError("Property ".concat(id, " already exists in this StoreControl instance."));
      ...
      value: function of(branch) {
        ...
        if (ret === null) throw new ReferenceError("Branch ".concat(branch, " does not exist in this StoreControl instance."));
        if (!this.isBranch(ret)) throw new TypeError("\"".concat(branch, "\" key does not link to a StoreControl branch."));
        return ret;
      }
    }, {
      key: "isBranch",
