    ...
    _createClass(StoreControl, [{
      ...
      value: function set(key, val) {
        ...
        if (i < 0) {
          i = this.size();
          this.entries[i] = [];
        } else if (this.values[i] instanceof StoreBranch) throw new TypeError("Cannot replace \"".concat(key, "\" because it is a user-defined StoreControl branch."));
      ...
      value: function branch(id) {
        if (this.has(id)) throw new TypeError("Property \"".concat(id, "\" already exists in this StoreControl instance."));
